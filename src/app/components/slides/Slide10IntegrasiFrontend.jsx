...
{`{
  ...
  "processing_time": 32.77
          ...
          {/* Right Column: Slide 8 Scrollable Image Container for Long Phone Screenshots */}
          <motion.div variants={item} className="col-span-7 flex flex-col items-center justify-center overflow-hidden">
